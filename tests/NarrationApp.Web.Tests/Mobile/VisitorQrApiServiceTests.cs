...
public sealed class VisitorQrApiServiceTests
{
    [Fact]
    ...
    private static VisitorQrApiService CreateService(Func<HttpRequestMessage, CancellationToken, Task<HttpResponseMessage>> handler)
    {
        ...
        return new VisitorQrApiService(httpClient);
    }
