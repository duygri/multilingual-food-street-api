...
public sealed class TouristAudioCatalogServiceTests
{
    [Fact]
    ...
    private static TouristAudioCatalogService CreateService(Func<HttpRequestMessage, CancellationToken, Task<HttpResponseMessage>> handler)
    {
        ...
        return new TouristAudioCatalogService(httpClient);
    }
