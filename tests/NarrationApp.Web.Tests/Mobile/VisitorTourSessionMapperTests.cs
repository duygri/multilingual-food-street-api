...
public sealed class VisitorTourSessionMapperTests
{
    [Fact]
    public void Map_UsesServerProgressToResolveNextStop()
    {
        var tour = new VisitorTourCard(
            "tour-9",
            "Tour ven sông",
            "2 điểm dừng",
            "30 phút",
        ...
        var session = VisitorTourSessionMapper.Map(
            tour,
            new TourSessionDto
            {
                Id = 14,
            ...
            [
                new VisitorPoi("poi-7", "Bến Nhà Rồng", "river", "Ven sông", "Quận 4", "Live API", "desc", "highlight", 18, 52, 180, "3:12", "Sẵn sàng", 10.7609, 106.7054),
                new VisitorPoi("poi-8", "Cầu Khánh Hội", "history", "Lịch sử", "Quận 4", "Live API", "desc", "highlight", 22, 46, 220, "2:44", "Sẵn sàng", 10.7680, 106.7068)
            ]);
