...
{
    [Fact]
    public void Public_qr_page_exists_and_exposes_qr_route_with_open_app_launcher_experience()
    {
        ...
        Assert.Contains("QR mở app", source, StringComparison.Ordinal);
        Assert.Contains("Launcher", source, StringComparison.Ordinal);
        Assert.Contains("Mở ứng dụng", source, StringComparison.Ordinal);
        Assert.Contains("app-button--primary", source, StringComparison.Ordinal);
