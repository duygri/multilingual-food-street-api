...
builder.Services.AddScoped<IQrDeviceConfigService, QrDeviceConfigService>();
...
builder.Services.AddScoped<IVisitorNotificationService, VisitorNotificationService>();
