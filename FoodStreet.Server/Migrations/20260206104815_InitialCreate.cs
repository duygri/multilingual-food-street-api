        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedStopMinutes = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Foods",
                columns: new[] { "Id", "Description", "ImageUrl", "Latitude", "Longitude", "MapLink", "Name", "OwnerId", "Price", "Priority", "Radius", "TtsScript" },
                values: new object[,]
                {
                    { 1, "Traditional Vietnamese beef noodle soup", null, 10.776889000000001, 106.700806, null, "Pho Bo", null, 45000m, 0, 50.0, null },
                    { 2, "Vietnamese baguette sandwich", null, 10.762622, 106.660172, null, "Banh Mi", null, 25000m, 0, 50.0, null },
                    { 3, "Broken rice with grilled pork", null, 10.792375, 106.691689, null, "Com Tam", null, 50000m, 0, 50.0, null }
                });
